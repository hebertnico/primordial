      ...
      {isVisible ? (
        <motion.div
          ...
          animate={{
            ...
            ...animate,
            ...(isHovered || isToggled
              ? { x: distance[0] * 0.15, y: distance[1] * 0.6, zIndex: 50 }
              : { x: 0, y: 0, zIndex: 10 }),
          }}
        ...
        >
          ...
          >
            <motion.div
              ...
              className={`${size} relative translate-x-[40%] translate-y-1/3 rounded-full shadow-lg [--activeSize:4] md:[--activeSize:3]`}
            >
              <motion.div
                animate={
                  isHovered || isToggled
