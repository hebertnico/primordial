...
function Home() {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative h-screen md:h-[150vh] flex items-center justify-center">
        <div className="absolute top-[40vh] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          <motion.h1
        ...
        <div className="absolute left-2 z-0 h-auto top-0 flex gap-4 pointer-events-none">
          <Parallax
            w={30}
            style={{
      ...
      <section
        ref={containerRef}
        className="relative flex flex-col h-[200vh] py-20 px-8  bg-my-cream text-my-black gap-5"
      >
